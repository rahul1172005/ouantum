...
export default function ReportingStudio({ selectedElement, setSelectedElement }) {
  const [activeTemplate, setActiveTemplate] = useState('compliance'); // compliance, structural, ndt
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 font-mono text-xs text-black">
      ...
      <div className="xl:col-span-1 space-y-6">
        ...
        <div className="border-2 border-black p-4 bg-white space-y-4">
          <p className="font-bold border-b border-black pb-1.5 uppercase text-[10px]">Report Template Builder</p>
          ...
          >
            <Sparkles className="h-4.5 w-4.5" /> AI Auto-Write Report
          </button>
        </div>

        {/* System parameters context watermarks */}
        <div className="border-2 border-black p-4 bg-white space-y-2 text-[9px]">
          <p className="font-bold border-b border-black pb-1.5 uppercase text-[10px]">Active Data Feeds</p>
      ...
      <div className="xl:col-span-2 space-y-4">
        ...
        <div className="border-2 border-black p-2 bg-white flex justify-between items-center">
          <span className="font-bold uppercase tracking-wider text-[10px]">Professional Blueprint Print Preview</span>
          <button 
            onClick={handlePrint}
            className="px-3 py-1 border border-black hover:bg-gray-50 flex items-center gap-1.5 font-bold font-mono text-[9px] uppercase"
          >
